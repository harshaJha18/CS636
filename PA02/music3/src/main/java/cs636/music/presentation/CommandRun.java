...
//		}
		...
		case "SystemTest":
			...
			SystemTest st = new SystemTest(catalogService, salesService);
			st.runSystemTest();
			break;
		case "UserApp":
			System.out.println("Starting UserApp from CommandRun");
			UserApp app = new UserApp(catalogService, salesService);
			app.handleCatalogPage(); // top level of app
			break;
		case "AdminApp":
			System.out.println("Starting AdminApp from CommandRun");
			AdminApp adminApp = new AdminApp(catalogService, salesService);
			adminApp.loginPage();
			break;
		default:
